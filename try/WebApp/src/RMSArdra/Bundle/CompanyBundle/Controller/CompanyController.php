...
namespace RMSArdra\Bundle\CompanyBundle\Controller;
...
use RMSArdra\Bundle\CompanyBundle\Entity\Company;
use RMSArdra\Bundle\CompanyBundle\Form\CompanyType;
...
class CompanyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RMSArdraCompanyBundle:Company')->findAll();
     ...
     * @Method("POST")
     * @Template("RMSArdraCompanyBundle:Company:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RMSArdraCompanyBundle:Company')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Company entity.');
        }
        $users = $em->getRepository('ApplicationSonataUserBundle:User')->findBy(array('company' => $entity));
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RMSArdraCompanyBundle:Company:edit.html.twig")
     */
