...
namespace RMSArdra\Bundle\RMSBundle\Menu;
...
class Builder extends ContainerAware
{
    ...
    public function basicNavbar(FactoryInterface $factory, array $options)
    {
        ...
        $item = $menu->addChild('Job Requirement', array('route' => 'jobrequirement'));
        $item = $menu->addChild('Candidate Profile', array('route' => 'candidateprofile'));
    ...
    /**
     * Builds the left responsive navbar menu.
     *
     * @param \Knp\Menu\FactoryInterface $factory The menu factory
     * @param array                      $options The options array
     *
     * @return \Knp\Menu\ItemInterface The root item
     */
    public function responsiveNavbarLeft(FactoryInterface $factory, array $options)
    {
        $menu = $factory->createItem('root');

        $menu->addChild('Company', array('route' => 'company'));
        $menu->addChild('Vendor', array('route' => 'vendor'));
        return $menu;
    }
}